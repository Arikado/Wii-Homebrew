# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/glut/glut_util.c"
...
# 9 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/glut/glut_util.c" 2
...
# 85 "c:\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-gekko/4.2.4/include/stdarg.h" 3 4
typedef __gnuc_va_list va_list;
# 10 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/glut/glut_util.c" 2
...
# 11 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/glut/glut_util.c" 2
...
# 5 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/glut/glutint.h" 2
# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/include/GL/glut.h" 1
# 138 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/include/GL/glut.h"
...
# 139 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/include/GL/glut.h" 2
...
# 13 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/glut/glut_util.c" 2
...
__glutWarning(char *format,...)
{
  ...
  fprintf((_impure_ptr->_stderr), "GLUT: Warning in %s: ",
    __glutProgramName ? __glutProgramName : "(unamed)");
  vfprintf((_impure_ptr->_stderr), format, args);
  __builtin_va_end(args);
  (--((_impure_ptr->_stderr))->_w < 0 ? ((_impure_ptr->_stderr))->_w >= ((_impure_ptr->_stderr))->_lbfsize ? (*((_impure_ptr->_stderr))->_p = ('\n')), *((_impure_ptr->_stderr))->_p != '\n' ? (int)*((_impure_ptr->_stderr))->_p++ : __swbuf_r(_impure_ptr, '\n', (_impure_ptr->_stderr)) : __swbuf_r(_impure_ptr, (int)('\n'), (_impure_ptr->_stderr)) : (*((_impure_ptr->_stderr))->_p = ('\n'), (int)*((_impure_ptr->_stderr))->_p++));
}
...
__glutFatalError(char *format,...)
{
  ...
  __builtin_va_start(args,format);
  fprintf((_impure_ptr->_stderr), "GLUT: Fatal Error in %s: ",
    __glutProgramName ? __glutProgramName : "(unamed)");
  vfprintf((_impure_ptr->_stderr), format, args);
  __builtin_va_end(args);
  (--((_impure_ptr->_stderr))->_w < 0 ? ((_impure_ptr->_stderr))->_w >= ((_impure_ptr->_stderr))->_lbfsize ? (*((_impure_ptr->_stderr))->_p = ('\n')), *((_impure_ptr->_stderr))->_p != '\n' ? (int)*((_impure_ptr->_stderr))->_p++ : __swbuf_r(_impure_ptr, '\n', (_impure_ptr->_stderr)) : __swbuf_r(_impure_ptr, (int)('\n'), (_impure_ptr->_stderr)) : (*((_impure_ptr->_stderr))->_p = ('\n'), (int)*((_impure_ptr->_stderr))->_p++));
...
__glutFatalUsage(char *format,...)
{
  ...
  __builtin_va_start(args,format);
  fprintf((_impure_ptr->_stderr), "GLUT: Fatal API Usage in %s: ",
    __glutProgramName ? __glutProgramName : "(unamed)");
  vfprintf((_impure_ptr->_stderr), format, args);
  __builtin_va_end(args);
  (--((_impure_ptr->_stderr))->_w < 0 ? ((_impure_ptr->_stderr))->_w >= ((_impure_ptr->_stderr))->_lbfsize ? (*((_impure_ptr->_stderr))->_p = ('\n')), *((_impure_ptr->_stderr))->_p != '\n' ? (int)*((_impure_ptr->_stderr))->_p++ : __swbuf_r(_impure_ptr, '\n', (_impure_ptr->_stderr)) : __swbuf_r(_impure_ptr, (int)('\n'), (_impure_ptr->_stderr)) : (*((_impure_ptr->_stderr))->_p = ('\n'), (int)*((_impure_ptr->_stderr))->_p++));
