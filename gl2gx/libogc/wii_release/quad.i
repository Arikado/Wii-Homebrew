# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libutil/quad.c"
# 1 "c:\\devkitPro\\examples\\wii\\freespace2wii\\gl2gx\\libogc\\wii_release//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libutil/quad.c"
# 38 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libutil/quad.c"
...
# 39 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libutil/quad.c" 2
# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libutil/gluint.h" 1
# 41 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libutil/gluint.h"
extern const char *__gluNURBSErrorString( int errno );

extern const char *__gluTessErrorString( int errno );
# 40 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libutil/quad.c" 2
...
# 43 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libutil/quad.c" 2
...
# 44 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libutil/quad.c" 2
...
# 45 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libutil/quad.c" 2
...
struct GLUquadric {
    ...
    GLint orientation;
    GLint drawStyle;
    void (__attribute__((visibility("default"))) *errorCallback)( GLint );
};

GLUquadric * __attribute__((visibility("default")))
gluNewQuadric(void)
{
    GLUquadric *newstate;
 ...
 return ((void *)0);
    ...
    newstate->normals = 100000;
    newstate->textureCoords = 0x0;
    newstate->orientation = 100020;
    newstate->drawStyle = 100012;
    newstate->errorCallback = ((void *)0);
    return newstate;
}
...
void __attribute__((visibility("default")))
gluQuadricCallback(GLUquadric *qobj, GLenum which, void (__attribute__((visibility("default"))) *fn)())
{
    switch (which) {
      case 100103:
 qobj->errorCallback = (void (__attribute__((visibility("default"))) *)(GLint)) fn;
 break;
      default:
 gluQuadricError(qobj, 100900);
 return;
    }
}
  ...
  GLdouble height, GLint slices, GLint stacks)
{
    ...
    GLfloat cosCache2[240];
    GLfloat sinCache3[240];
    GLfloat cosCache3[240];
    GLfloat angle;
    ...
    if (slices >= 240) slices = 240 -1;

    if (slices < 2 || stacks < 1 || baseRadius < 0.0 || topRadius < 0.0 ||
     height < 0.0) {
 gluQuadricError(qobj, 100901);
 return;
    }
 ...
 return;
    ...
    if (qobj->normals == 100000) {
 needCache2 = 1;
    }

    if (qobj->normals == 100001) {
 if (qobj->drawStyle != 100010) {
     needCache3 = 1;
 }
 if (qobj->drawStyle == 100011) {
     needCache2 = 1;
 }
    }
 ...
 cosCache3[slices] = cosCache3[0];
    ...
    switch (qobj->drawStyle) {
      case 100012:
# 264 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libutil/quad.c"
 for (j = 0; j < stacks; j++) {
...
{
    GLint i,j,max;
    GLfloat sinCache1a[240];
    GLfloat cosCache1a[240];
    GLfloat sinCache2a[240];
    GLfloat cosCache2a[240];
    GLfloat sinCache3a[240];
    GLfloat cosCache3a[240];
    GLfloat sinCache1b[240];
    GLfloat cosCache1b[240];
    GLfloat sinCache2b[240];
    GLfloat cosCache2b[240];
    GLfloat sinCache3b[240];
    GLfloat cosCache3b[240];
    GLfloat angle;
    GLfloat x, y, zLow, zHigh;
