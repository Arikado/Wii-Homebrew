# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq.c"
# 1 "c:\\devkitPro\\examples\\wii\\freespace2wii\\gl2gx\\libogc\\wii_release//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq.c"
# 42 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq.c"
...
# 43 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq.c" 2
# 1 "c:\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-gekko/4.2.4/include/stddef.h" 1 3 4
# 44 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq.c" 2
...
# 45 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq.c" 2
# 1 "c:\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-gekko/4.2.4/include/limits.h" 1 3 4
# 46 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq.c" 2
...
# 47 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq.c" 2



# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq-heap.c" 1
# 42 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq-heap.c"
# 1 "c:\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-gekko/4.2.4/include/stddef.h" 1 3 4
# 43 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq-heap.c" 2
# 1 "c:\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-gekko/4.2.4/../../../../powerpc-gekko/include/assert.h" 1 3
# 39 "c:\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-gekko/4.2.4/../../../../powerpc-gekko/include/assert.h" 3
void __assert (const char *, int, const char *) __attribute__ ((__noreturn__));

void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__));
# 44 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq-heap.c" 2
...
# 45 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq-heap.c" 2
# 56 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq-heap.c"
# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/geom.h" 1
# 45 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/geom.h"
...
# 46 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/geom.h" 2
...
void __gl_edgeIntersect( GLUvertex *o1, GLUvertex *d1,
        ...
        GLUvertex *v );
# 57 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq-heap.c" 2
...
PriorityQHeap *__gl_pqHeapNewPriorityQ(int (*leq)(PQHeapKey key1, PQHeapKey key2))
{
  PriorityQHeap *pq = (PriorityQHeap *)malloc( sizeof( PriorityQHeap ));
  if (pq == ((void *)0)) return ((void *)0);

  pq->size = 0;
  pq->max = 32;
  pq->nodes = (PQnode *)malloc( (32 + 1) * sizeof(pq->nodes[0]) );
  if (pq->nodes == ((void *)0)) {
     free(pq);
     return ((void *)0);
  }

  pq->handles = (PQhandleElem *)malloc( (32 + 1) * sizeof(pq->handles[0]) );
...
static void FloatDown( PriorityQHeap *pq, long curr )
{
  ...
  PQHeapHandle hCurr, hChild;
  long child;

  hCurr = n[curr].handle;
  for( ;; ) {
    child = curr << 1;
    if( child < pq->size && ((((GLUvertex *)h[n[child+1].handle].key)->s < ((GLUvertex *)h[n[child].handle].key)->s) || (((GLUvertex *)h[n[child+1].handle].key)->s == ((GLUvertex *)h[n[child].handle].key)->s && ((GLUvertex *)h[n[child+1].handle].key)->t <= ((GLUvertex *)h[n[child].handle].key)->t))) {
    ...
    if( child > pq->size || ((((GLUvertex *)h[hCurr].key)->s < ((GLUvertex *)h[hChild].key)->s) || (((GLUvertex *)h[hCurr].key)->s == ((GLUvertex *)h[hChild].key)->s && ((GLUvertex *)h[hCurr].key)->t <= ((GLUvertex *)h[hChild].key)->t))) {
      n[curr].handle = hCurr;
      h[hCurr].node = curr;
      break;
    }
...
static void FloatUp( PriorityQHeap *pq, long curr )
{
  ...
  for( ;; ) {
    ...
    if( parent == 0 || ((((GLUvertex *)h[hParent].key)->s < ((GLUvertex *)h[hCurr].key)->s) || (((GLUvertex *)h[hParent].key)->s == ((GLUvertex *)h[hCurr].key)->s && ((GLUvertex *)h[hParent].key)->t <= ((GLUvertex *)h[hCurr].key)->t))) {
      n[curr].handle = hCurr;
      h[hCurr].node = curr;
      break;
    }
...
PQHeapHandle __gl_pqHeapInsert(PriorityQHeap *pq,PQHeapKey keyNew)
{
  ...
  if( (curr*2) > pq->max ) {
    ...
    pq->handles = (PQhandleElem *)realloc( pq->handles,
                        (size_t)
                         ((pq->max + 1) *
            sizeof( pq->handles[0] )));
    if (pq->handles == ((void *)0)) {
...
PQHeapKey __gl_pqHeapExtractMin(PriorityQHeap *pq)
{
  PQnode *n = pq->nodes;
  PQhandleElem *h = pq->handles;
  PQHeapHandle hMin = n[1].handle;
  PQHeapKey min = h[hMin].key;
...
void __gl_pqHeapDelete(PriorityQHeap *pq,PQHeapHandle hCurr)
{
  ...
  if( curr <= -- pq->size ) {
    if( curr <= 1 || ((((GLUvertex *)h[n[curr>>1].handle].key)->s < ((GLUvertex *)h[n[curr].handle].key)->s) || (((GLUvertex *)h[n[curr>>1].handle].key)->s == ((GLUvertex *)h[n[curr].handle].key)->s && ((GLUvertex *)h[n[curr>>1].handle].key)->t <= ((GLUvertex *)h[n[curr].handle].key)->t))) {
      FloatDown( pq, curr );
    } else {
      FloatUp( pq, curr );
    }
...
# 51 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq.c" 2



# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq-sort.h" 1
# 100 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq-sort.h"
...
# 55 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq.c" 2
...
# 111 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq.c"
  ...
  while( --top >= Stack ) {
    ...
    while( r > p + 10 ) {
      ...
      *p = piv;
      ...
      j = r + 1;
      do {
 do { ++i; } while( (! ((((GLUvertex *)**i)->s < ((GLUvertex *)*piv)->s) || (((GLUvertex *)**i)->s == ((GLUvertex *)*piv)->s && ((GLUvertex *)**i)->t <= ((GLUvertex *)*piv)->t))));
 do { --j; } while( (! ((((GLUvertex *)*piv)->s < ((GLUvertex *)**j)->s) || (((GLUvertex *)*piv)->s == ((GLUvertex *)**j)->s && ((GLUvertex *)*piv)->t <= ((GLUvertex *)**j)->t))));
 ...
 p = j+1;
    ...
    for( i = p+1; i <= r; ++i ) {
      piv = *i;
      for( j = i; j > p && (! ((((GLUvertex *)*piv)->s < ((GLUvertex *)**(j-1))->s) || (((GLUvertex *)*piv)->s == ((GLUvertex *)**(j-1))->s && ((GLUvertex *)*piv)->t <= ((GLUvertex *)**(j-1))->t))); --j ) {
 *j = *(j-1);
      }
      *j = piv;
    }
...
# 175 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/priorityq.c"
  return 1;
}
...
PQSortKey __gl_pqSortExtractMin(PriorityQSort *pq)
{
  ...
  if( ! ((pq->heap)->size == 0)) {
    ...
    if( ((((GLUvertex *)heapMin)->s < ((GLUvertex *)sortMin)->s) || (((GLUvertex *)heapMin)->s == ((GLUvertex *)sortMin)->s && ((GLUvertex *)heapMin)->t <= ((GLUvertex *)sortMin)->t))) {
      return __gl_pqHeapExtractMin( pq->heap );
    }
  }
  do {
