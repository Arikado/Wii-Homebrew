# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/tessmono.c"
# 1 "c:\\devkitPro\\examples\\wii\\freespace2wii\\gl2gx\\libogc\\wii_release//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/tessmono.c"
# 42 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/tessmono.c"
...
# 43 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/tessmono.c" 2
...
void __gl_edgeIntersect( GLUvertex *o1, GLUvertex *d1,
        ...
        GLUvertex *v );
# 45 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/tessmono.c" 2
...
# 47 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/tessmono.c" 2
...
# 48 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/tessmono.c" 2
# 79 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/tessmono.c"
int __gl_meshTessellateMonoRegion( GLUface *face )
{
  GLUhalfEdge *up, *lo;
  ...
  for( ; (((up->Sym->Org)->s < (up->Org)->s) || ((up->Sym->Org)->s == (up->Org)->s && (up->Sym->Org)->t <= (up->Org)->t)); up = up->Onext->Sym )
    ;
  for( ; (((up->Org)->s < (up->Sym->Org)->s) || ((up->Org)->s == (up->Sym->Org)->s && (up->Org)->t <= (up->Sym->Org)->t)); up = up->Lnext )
    ;
  lo = up->Onext->Sym;

  while( up->Lnext != lo ) {
    if( (((up->Sym->Org)->s < (lo->Org)->s) || ((up->Sym->Org)->s == (lo->Org)->s && (up->Sym->Org)->t <= (lo->Org)->t))) {




      while( lo->Lnext != up && (((((lo->Lnext)->Sym->Org)->s < ((lo->Lnext)->Org)->s) || (((lo->Lnext)->Sym->Org)->s == ((lo->Lnext)->Org)->s && ((lo->Lnext)->Sym->Org)->t <= ((lo->Lnext)->Org)->t))
      || __gl_edgeSign(lo->Org,lo->Sym->Org,lo->Lnext->Sym->Org) <= 0 )) {
 ...
 lo = tempHalfEdge->Sym;
      ...
      while( lo->Lnext != up && (((((up->Onext->Sym)->Org)->s < ((up->Onext->Sym)->Sym->Org)->s) || (((up->Onext->Sym)->Org)->s == ((up->Onext->Sym)->Sym->Org)->s && ((up->Onext->Sym)->Org)->t <= ((up->Onext->Sym)->Sym->Org)->t))
      || __gl_edgeSign(up->Sym->Org,up->Org,up->Onext->Sym->Org) >= 0 )) {
 GLUhalfEdge *tempHalfEdge= __gl_meshConnect( up, up->Onext->Sym );
 if (tempHalfEdge == ((void *)0)) return 0;
 up = tempHalfEdge->Sym;
      }
      up = up->Lnext;
...
# 186 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/tessmono.c"
int __gl_meshSetWindingNumber( GLUmesh *mesh, int value,
           GLboolean keepOnlyBoundary )
{
  GLUhalfEdge *e, *eNext;
