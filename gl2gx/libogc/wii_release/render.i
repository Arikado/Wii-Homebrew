# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c"
# 1 "c:\\devkitPro\\examples\\wii\\freespace2wii\\gl2gx\\libogc\\wii_release//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c"
# 42 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c"
...
# 43 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c" 2
...
# 44 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c" 2
# 1 "c:\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-gekko/4.2.4/include/stddef.h" 1 3 4
# 45 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c" 2
...
# 46 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c" 2
# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/tess.h" 1
# 46 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/tess.h"
...
# 47 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/tess.h" 2
...
void __attribute__((visibility("default"))) __gl_noCombineData( GLdouble coords[3], void *data[4],
    GLfloat weight[4], void **outData,
    void *polygonData );
# 47 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c" 2
...
# 48 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c" 2
# 56 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c"
struct FaceCount {
  long size;
  GLUhalfEdge *eStart;
...
# 85 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c"
void __gl_renderMesh( GLUtesselator *tess, GLUmesh *mesh )
{
  GLUface *f;
...
static void RenderMaximumFaceGroup( GLUtesselator *tess, GLUface *fOrig )
{
  ...
  if( ! tess->flagBoundary ) {
    ...
    newFace = MaximumFan( e->Onext->Sym ); if( newFace.size > max.size ) { max = newFace; }

    newFace = MaximumStrip( e ); if( newFace.size > max.size ) { max = newFace; }
    newFace = MaximumStrip( e->Lnext ); if( newFace.size > max.size ) { max = newFace; }
    newFace = MaximumStrip( e->Onext->Sym ); if( newFace.size > max.size ) { max = newFace; }
  }
  (*(max.render))( tess, max.eStart, max.size );
}
# 161 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c"
static struct FaceCount MaximumFan( GLUhalfEdge *eOrig )
{
  ...
  for( e = eOrig; ! (! (e->Lface)->inside || (e->Lface)->marked); e = e->Onext ) {
    ((e->Lface)->trail = (trail), (trail) = (e->Lface), (e->Lface)->marked = 1);
    ++newFace.size;
  }
  for( e = eOrig; ! (! (e->Sym->Lface)->inside || (e->Sym->Lface)->marked); e = e->Sym->Lnext ) {
    ((e->Sym->Lface)->trail = (trail), (trail) = (e->Sym->Lface), (e->Sym->Lface)->marked = 1);
    ++newFace.size;
  }
  newFace.eStart = e;

  if( 1 ) { while( (trail) != ((void *)0) ) { (trail)->marked = 0; trail = (trail)->trail; } } else;
  return newFace;
}
...
static struct FaceCount MaximumStrip( GLUhalfEdge *eOrig )
{
# 200 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c"
  struct FaceCount newFace = { 0, ((void *)0), &RenderStrip };
  long headSize = 0, tailSize = 0;
  GLUface *trail = ((void *)0);
  GLUhalfEdge *e, *eTail, *eHead;

  for( e = eOrig; ! (! (e->Lface)->inside || (e->Lface)->marked); ++tailSize, e = e->Onext ) {
    ((e->Lface)->trail = (trail), (trail) = (e->Lface), (e->Lface)->marked = 1);
    ++tailSize;
    e = e->Lnext->Sym;
    if( (! (e->Lface)->inside || (e->Lface)->marked)) break;
    ((e->Lface)->trail = (trail), (trail) = (e->Lface), (e->Lface)->marked = 1);
  }
  eTail = e;

  for( e = eOrig; ! (! (e->Sym->Lface)->inside || (e->Sym->Lface)->marked); ++headSize, e = e->Sym->Onext->Sym ) {
    ((e->Sym->Lface)->trail = (trail), (trail) = (e->Sym->Lface), (e->Sym->Lface)->marked = 1);
    ++headSize;
    e = e->Sym->Lnext;
    if( (! (e->Sym->Lface)->inside || (e->Sym->Lface)->marked)) break;
    ((e->Sym->Lface)->trail = (trail), (trail) = (e->Sym->Lface), (e->Sym->Lface)->marked = 1);
  }
  eHead = e;
...
static void RenderTriangle( GLUtesselator *tess, GLUhalfEdge *e, long size )
{
  ...
  ((void)0);
  ((e->Lface)->trail = (tess->lonelyTriList), (tess->lonelyTriList) = (e->Lface), (e->Lface)->marked = 1);
}
...
static void RenderLonelyTriangles( GLUtesselator *tess, GLUface *f )
{
  ...
  if (tess->callBeginData != &__gl_noBeginData) (*tess->callBeginData)((0x0004),tess->polygonData); else (*tess->callBegin)((0x0004));;
 ...
 newState = ! e->Sym->Lface->inside;
 if( edgeState != newState ) {
   edgeState = newState;
          if (tess->callEdgeFlagData != &__gl_noEdgeFlagData) (*tess->callEdgeFlagData)((edgeState),tess->polygonData); else (*tess->callEdgeFlag)((edgeState));;
 }
      }
      if (tess->callVertexData != &__gl_noVertexData) (*tess->callVertexData)((e->Org->data),tess->polygonData); else (*tess->callVertex)((e->Org->data));;
...
static void RenderFan( GLUtesselator *tess, GLUhalfEdge *e, long size )
{
  ...
  if (tess->callBeginData != &__gl_noBeginData) (*tess->callBeginData)((0x0006),tess->polygonData); else (*tess->callBegin)((0x0006));;
  if (tess->callVertexData != &__gl_noVertexData) (*tess->callVertexData)((e->Org->data),tess->polygonData); else (*tess->callVertex)((e->Org->data));;
  if (tess->callVertexData != &__gl_noVertexData) (*tess->callVertexData)((e->Sym->Org->data),tess->polygonData); else (*tess->callVertex)((e->Sym->Org->data));;

  while( ! (! (e->Lface)->inside || (e->Lface)->marked)) {
    e->Lface->marked = 1;
    --size;
    e = e->Onext;
    if (tess->callVertexData != &__gl_noVertexData) (*tess->callVertexData)((e->Sym->Org->data),tess->polygonData); else (*tess->callVertex)((e->Sym->Org->data));;
...
static void RenderStrip( GLUtesselator *tess, GLUhalfEdge *e, long size )
{
  ...
  if (tess->callBeginData != &__gl_noBeginData) (*tess->callBeginData)((0x0005),tess->polygonData); else (*tess->callBegin)((0x0005));;
  if (tess->callVertexData != &__gl_noVertexData) (*tess->callVertexData)((e->Org->data),tess->polygonData); else (*tess->callVertex)((e->Org->data));;
  if (tess->callVertexData != &__gl_noVertexData) (*tess->callVertexData)((e->Sym->Org->data),tess->polygonData); else (*tess->callVertex)((e->Sym->Org->data));;
...
# 342 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c"
void __gl_renderBoundary( GLUtesselator *tess, GLUmesh *mesh )
{
  GLUface *f;
  GLUhalfEdge *e;
  ...
  for( f = mesh->fHead.next; f != &mesh->fHead; f = f->next ) {
    if( f->inside ) {
      if (tess->callBeginData != &__gl_noBeginData) (*tess->callBeginData)((0x0002),tess->polygonData); else (*tess->callBegin)((0x0002));;
      e = f->anEdge;
      do {
        if (tess->callVertexData != &__gl_noVertexData) (*tess->callVertexData)((e->Org->data),tess->polygonData); else (*tess->callVertex)((e->Org->data));;
 e = e->Lnext;
...
# 374 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c"
{
  ...
  int sign = 0;
# 394 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c"
  if( ! check ) {
...
# 444 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/render.c"
GLboolean __gl_renderCache( GLUtesselator *tess )
{
  CachedVertex *v0 = tess->cache;
  CachedVertex *vn = v0 + tess->cacheCount;
  ...
  if( norm[0] == 0 && norm[1] == 0 && norm[2] == 0 ) {
    ComputeNormal( tess, norm, 0 );
  }

  sign = ComputeNormal( tess, norm, 1 );
  if( sign == 2 ) {
  ...
  if (tess->callBeginData != &__gl_noBeginData) (*tess->callBeginData)((tess->boundaryOnly ? 0x0002 : (tess->cacheCount > 3) ? 0x0006 : 0x0004),tess->polygonData); else (*tess->callBegin)((tess->boundaryOnly ? 0x0002 : (tess->cacheCount > 3) ? 0x0006 : 0x0004));;



  if (tess->callVertexData != &__gl_noVertexData) (*tess->callVertexData)((v0->data),tess->polygonData); else (*tess->callVertex)((v0->data));;
  if( sign > 0 ) {
    for( vc = v0+1; vc < vn; ++vc ) {
      if (tess->callVertexData != &__gl_noVertexData) (*tess->callVertexData)((vc->data),tess->polygonData); else (*tess->callVertex)((vc->data));;
    }
  } else {
