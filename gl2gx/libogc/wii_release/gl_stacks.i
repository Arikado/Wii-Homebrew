# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c"
...
# 2 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c" 2
...
# 3 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c" 2
...
# 4 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c" 2
...
# 5 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c" 2
...
# 10 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/include/glint.h" 2
...
# 7 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c" 2
...
static bool pushAccum(void ** p, void * end)
{
 ...
 if((void*)((*ptr)+1) > end) { return false; };
...
# 48 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c"
...
# 125 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c"
...
# 245 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c"
...
static void popEnable(void ** p)
{
 ...
 depthtestenabled = (*ptr)->depth_test == 1 ? 0x1 : false;
...
# 370 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c"
typedef struct fog
{
...
# 461 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c"
...
# 585 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c"
...
# 674 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c"
...
# 827 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c"
...
static void push(attribStack_t * ptr, AttribOpt * opts, size_t n_opts, GLenum mask)
{
 ...
 if(ptr->typeCur >= 16)
 {
  _glSetErrorEx(0x0503, "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c", 1043);
  return;
 }
  ...
  if((opts[i].mask & mask) == opts[i].mask)
  {
   while(!opts[i].push(&cur, stackEnd(ptr)))
   {
    ...
    if(!resizeStack(ptr))
    {
     ...
     _glSetErrorEx(0x0503, "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c", 1062);
     return;
    }
   }
  }
...
static void pop(attribStack_t * ptr, AttribOpt * opts, size_t n_opts)
{
 ...
 if(ptr->typeCur == 0)
 {
  _glSetErrorEx(0x0504, "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c", 1082);
  return;
 }
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c", 1107); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c", 1114); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c", 1202); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/gl_stacks.c", 1209); return; };
