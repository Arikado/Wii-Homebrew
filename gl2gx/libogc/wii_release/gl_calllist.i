# 1 "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c"
...
# 2 "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c" 2
...
# 3 "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c" 2
...
# 4 "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c" 2
# 1 "c:\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-gekko/4.2.4/../../../../powerpc-gekko/include/malloc.h" 1 3
# 10 "c:\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-gekko/4.2.4/../../../../powerpc-gekko/include/malloc.h" 3
# 1 "c:\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-gekko/4.2.4/include/stddef.h" 1 3 4
...
# 5 "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c" 2
...
# 6 "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c" 2
...
# 8 "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c" 2
...
_Bool resize_lists(CallListMan *this, size_t newsize)
{
...
GLuint ReadUint(const GLvoid ** pixels, GLenum type)
{
 ...
 case 0x1400:
 {
  s8 ** p = (s8 **)pixels;
  s8 t = *(*p)++;
  return ((t+call_offset) > 0 ? (t+call_offset) : 0);
 }
 break;
 case 0x1402:
 {
...
_Bool is_list(CallListMan *this, GLuint list)
{
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c", 246); return 0; };

 if(range < 0)
 {
  _glSetErrorEx(0x0501, "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c", 250);
  return 0;
 }
...
void glCallList(GLuint list)
{
 ...
 if(cur_state & GL_STATE_NEWLIST) { _glSetErrorEx(0x0502, "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c", 272); return; }
...
void glDeleteLists(GLuint list,
                   GLsizei range)
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c", 290); return; };

 if(range < 0)
 {
  _glSetErrorEx(0x0501, "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c", 294);
  return;
 }
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c", 303); return 0x0; };

 return (is_list(&listMan, list) ? 0x1 : 0x0);
}

void glNewList(GLuint list,
               GLenum mode)
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c", 311); return; };
 if(cur_state & GL_STATE_NEWLIST) { _glSetErrorEx(0x0502, "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c", 312); return; }
 ...
 if(!cur_list)
 {
  _glSetErrorEx(0x0501, "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c", 321);
  return;
 }

 if(!cur_list->used)
 {
  _glSetErrorEx(0x0501, "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c", 327);
  return;
 }
 ...
 switch(mode)
 {
  ...
  case 0x1301:
   ...
   break;
  default:
   _glSetErrorEx(0x0500, "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c", 338);
   return;
 }

 cur_list->list = memalign(32, (1000*(4+2*4*3+8*2*4)));
 cur_list->size = (1000*(4+2*4*3+8*2*4));
...
void glEndList()
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c", 350); return; };
 if(!(cur_state & GL_STATE_NEWLIST)) { _glSetErrorEx(0x0502, "c:/devkitPro/examples/wii/cube_source/gl2gx/libogc/../source/gl_calllist.c", 351); return; }
