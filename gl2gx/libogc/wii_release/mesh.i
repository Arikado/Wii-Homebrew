# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/mesh.c"
# 1 "c:\\devkitPro\\examples\\wii\\freespace2wii\\gl2gx\\libogc\\wii_release//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/mesh.c"
# 42 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/mesh.c"
...
# 43 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/mesh.c" 2
# 1 "c:\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-gekko/4.2.4/include/stddef.h" 1 3 4
# 44 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/mesh.c" 2
...
# 45 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/mesh.c" 2
...
# 46 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/mesh.c" 2
...
# 47 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/mesh.c" 2
...
{
   return (GLUvertex *)malloc( sizeof( GLUvertex ));
}

static GLUface *allocFace()
{
   return (GLUface *)malloc( sizeof( GLUface ));
}
...
GLUhalfEdge *__gl_meshMakeEdge( GLUmesh *mesh )
{
  ...
  if (newVertex1 == ((void *)0) || newVertex2 == ((void *)0) || newFace == ((void *)0)) {
     if (newVertex1 != ((void *)0)) free(newVertex1);
     if (newVertex2 != ((void *)0)) free(newVertex2);
     if (newFace != ((void *)0)) free(newFace);
     return ((void *)0);
  }
...
# 326 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/mesh.c"
int __gl_meshSplice( GLUhalfEdge *eOrg, GLUhalfEdge *eDst )
{
  int joiningLoops = 0;
...
# 382 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/mesh.c"
int __gl_meshDelete( GLUhalfEdge *eDel )
{
...
# 444 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/mesh.c"
GLUhalfEdge *__gl_meshAddEdgeVertex( GLUhalfEdge *eOrg )
{
  GLUhalfEdge *eNewSym;
...
# 506 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/mesh.c"
GLUhalfEdge *__gl_meshConnect( GLUhalfEdge *eOrg, GLUhalfEdge *eDst )
{
  GLUhalfEdge *eNewSym;
  int joiningLoops = 0;
...
# 553 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/mesh.c"
void __gl_meshZapFace( GLUface *fZap )
{
...
GLUmesh *__gl_meshNewMesh( void )
{
  ...
  GLUhalfEdge *e;
  GLUhalfEdge *eSym;
  GLUmesh *mesh = (GLUmesh *)malloc( sizeof( GLUmesh ));
  if (mesh == ((void *)0)) {
     return ((void *)0);
  }
...
# 709 "c:/devkitPro/examples/wii/freespace2wii/gl2gx/libogc/../source/libtess/mesh.c"
void __gl_meshDeleteMesh( GLUmesh *mesh )
{
  GLUface *f, *fNext;
  GLUvertex *v, *vNext;
